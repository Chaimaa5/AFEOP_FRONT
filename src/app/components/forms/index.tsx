...
import { updateEndDate, updateFormData, updateHours, updateOpenModal, updateOption, updateRange, updateRangeDataUrls, updateRangeUrls, updateResponse, updateStartDate, updateUnit } from "../../../store/features/formSlice";
...
import { updateAddRaster, updateColorMap, updateRasterBar, updateRasterUrl } from "../../../store/features/rasterSlice";
...
export default function Forms() {
    ...
    // const handleOptionSelection = (e: any) => {  console.log(e.target.value); };
    ...
    const handleOptionSelection = (e: any) => {
        ...
        if (selectedCode == "LST") {
            dispatch(updateColorMap('YlOrRd'))
        }
        else
            dispatch(updateColorMap('SM_Viridis'))

        // setSelectedOption(selectedCode);
        // if (selectedObj) {
        //     setUnit(selectedObj.Unit);
        // }
    };
    ...
    return (
        <>
            <Modal isOpen={openModal} onOpenChange={onOpenChange}  >
                <ModalContent>
                    <ModalHeader className="flex flex-col gap-1 items-center justify-center text-blue">Data Extraction</ModalHeader>
