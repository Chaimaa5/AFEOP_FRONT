...
const HydrologySection: React.FC = () => {
  ...
  const features = [
    {
      ...
      image: "/images/SM.jpg",
      description: "Map of SM threshold separating Stage I and Stage II"
    },
    {
      id: 2,
      title: "dT Analysis",
      image: "/images/SM.jpg",
      description: "dT analysis at the pixel scale over a long period of time"
    },
    {
      id: 3,
      title: "Water-Limited Regime",
      image: "/images/SM.jpg",
      description: "Fraction of time spent in water-limited regime"
    },
    {
      id: 4,
      title: "Regime Classification",
      image: "/images/SM.jpg",
      description: "Hydrologic regime classification"
    },
    {
      id: 5,
      title: "NDVI Contribution",
      image: "/images/SM.jpg",
      description: "Relative contribution of NDVI on SM threshold"
    },
  ];
  ...
  const currentFeature = hoveredIndex !== null ? features[hoveredIndex] : null;
  ...
  return (
    ...
    >
      ...
      <div className="relative container mx-auto px-6 lg:px-8">
        ...
        >
          <motion.span 
            className="inline-block px-6 py-3 rounded-full border-2 border-darkgreen text-green2 text-xs font-semibold uppercase tracking-widest mb-8"
          ...
          <motion.h2 
              className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold  leading-[1.1] mb-0"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          >
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="flex items-center justify-between group">
                  <motion.h3
                    className={`text-3xl lg:text-4xl xl:text-5xl font-bold transition-all duration-500 ${
                      hoveredIndex === index
                        ? 'text-green2'
                        : 'text-gray-300'
                    }`}
            ...
            >
              ...
              >
                <span>Explore Hydrological Data</span>
          ...
          {/* RIGHT: Image Display - Hidden by default, shown on hover */}
          <AnimatePresence>
            {hoveredIndex !== null && (
              <motion.div
              ...
              >
                <AnimatePresence mode="wait">
                  <motion.div
                    ...
                    transition={{ duration: 0.3 }}
                  >
                    {hoveredIndex !== null ? `0${hoveredIndex + 1} / 0${features.length}` : ''}
                  </motion.div>
                </AnimatePresence>
              </motion.div>
